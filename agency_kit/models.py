...
Defaults keep OpenAI (non-breaking):
  AK_ELITE_MODEL     elite tier  (🎖️)  default: "gpt-5"
  AK_STANDARD_MODEL  standard    (🔵)  default: "gpt-5-mini"
...
(`agency run`, the mission, a direct soldier import) picks it up. Dependency-free.
"""
...
ELITE = os.getenv("AK_ELITE_MODEL", "gpt-5")
STANDARD = os.getenv("AK_STANDARD_MODEL", "gpt-5-mini")
